...
#curl -L https://alist-home.320888.xyz/Oracle/App/dnsproxy-0.52.0.zip -o feeds/packages/net/dnsproxy.zip
curl -L https://alist-home.320888.xyz/Oracle/App/dnsproxy.zip -o feeds/packages/net/dnsproxy.zip
